...
| OAuth/Embedded Signup state and callback contract | Ready                        | Adapter complete; values blocked |
...
| Media download                                    | Interface and metadata ready | Bounded adapter; values blocked  |
| WhatsApp template inventory                       | Deterministic contract       | Sync adapter; values blocked     |
