...
| Recipe Gallery | Route skeleton              | Five fixed safe recipes       | Missing prerequisite explanation   | Channel/policy limits                      | Open builder                               |
| Test Center    | Route skeleton              | Synthetic example             | Provider/AI failure reason         | Preview/simulation/sandbox/pilot separated | Open automation safe test                  |
| Analytics      | Route skeleton              | Zero stored counts            | Partial count remains explicit     | No inferred or decorative metrics          | Drill into source records                  |
