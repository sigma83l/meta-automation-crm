...
| Automations  | Policy/version loading card | Recipe prompt                 | Not-found foreign ID             | Needs setup/reauth/approval/status pills | Safe test, pause, stop queue, last failure |
| CRM          | Customer loading card       | Create-first-customer guide   | Generic workspace-safe API error | Partial rows retained                    | Retry/edit/export request                  |
